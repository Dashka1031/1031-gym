...
const T = {
  ...
  en: {
    nav: ["Services", "Trainer", "Pricing", "Access", "Contact"],
    hero_sub: "Private Studio · One-on-One Training",
    hero_h1: "Transform Your Body,\nTransform Your Life",
    hero_p: "Personal training gym based in Kobe. Science-based training and nutrition guidance to help you achieve your ideal body.",
    hero_cta: "Book a Free Consultation",
    hero_sub2: "View Pricing",
    stats: [
      { num: "1:1", label: "Personal Training" },
      { num: "¥0", label: "No Enrollment Fee" },
      { num: "Private", label: "Exclusive Studio Space" },
      { num: "Kobe", label: "4 min from Station" },
    ],
    about_label: "About Us",
    about_h2: "About 10.31 LLC",
    about_p1: "With a background in medical science and 10 years of fitness experience, I provide training and nutrition guidance grounded in a deep understanding of the human body.",
    about_p2: "Through science-backed coaching, I help you achieve real, lasting transformation in both your body and your life.",
    trainer_label: "Trainer",
    trainer_h2: "Meet Your Trainer",
    trainer_name: "BATTUR DASHNYAM",
    trainer_role: "Personal Trainer · Representative",
    trainer_msg: "I believe that transforming your body transforms your life. I provide dedicated, personalized support for every client until they reach their goals. Feel free to reach out anytime.",
    service_label: "Services",
    service_h2: "What We Offer",
    services: [
      { icon: "◈", title: "Personal Training", desc: "Custom training programs tailored to your goals, fitness level, and lifestyle. Train in a fully private studio." },
      { icon: "◉", title: "Nutrition Guidance", desc: "Ongoing diet support via LINE. We build sustainable eating habits together — no extreme restrictions." },
      { icon: "◎", title: "Body Composition Analysis", desc: "Track your progress with detailed body composition data. Stay motivated by seeing real numbers change." },
      { icon: "◇", title: "Online Support", desc: "Got questions on non-training days? Reach out via LINE anytime and get quick answers." },
    ],
    plan_label: "Pricing",
    plan_h2: "Plans & Pricing",
    plan_note: "No enrollment fee ／ No admin fee",
    plans: [
      { name: "First Visit", sessions: "Consultation", price: "Free", tax: "", tag: null },
      { name: "Trial Session", sessions: "1 session · 75 min", price: "¥2,000", tax: "excl. tax", tag: "First time" },
      { name: "10 Sessions/Month", sessions: "1 month", price: "¥55,000", tax: "incl. tax", tag: "Popular" },
      { name: "12 Sessions/Month", sessions: "1 month", price: "¥60,000", tax: "incl. tax", tag: null },
    ],
    flow_label: "How It Works",
    flow_h2: "From Sign-Up to First Session",
    flows: [
      { title: "Contact Us", desc: "Reach out via form, LINE, or phone." },
      { title: "Free Consultation", desc: "We discuss your goals and concerns. Full explanation of pricing and program content." },
      { title: "Trial Session", desc: "After a body composition check, experience a real personal training session (75 min · ¥2,000 excl. tax)." },
      { title: "Choose Your Plan", desc: "We recommend the best plan based on your trial feedback. You can start right away." },
    ],
    access_label: "Access",
    access_h2: "Studio Info",
    access_info: [
      { label: "Address", value: "Okada Bldg. 2F, 4-1-11 Tamoncho, Chuo-ku, Kobe" },
      { label: "Access", value: "4 min walk from JR Kobe Station / 3 min from Kosoku Kobe Station" },
      { label: "Hours", value: "7:00 – 22:00 (by appointment)" },
      { label: "Closed", value: "Irregular" },
      { label: "Phone", value: "090-8738-9899" },
    ],
    company_label: "Company Info",
    company: [
      { label: "Company", value: "10.31 LLC (合同会社)" },
      { label: "Founded", value: "February 24, 2026" },
      { label: "Representative", value: "BATTUR DASHNYAM" },
      { label: "Address", value: "Okada Bldg. 2F, 4-1-11 Tamoncho, Chuo-ku, Kobe" },
      { label: "Business", value: "Personal training gym operations" },
    ],
    contact_label: "Contact",
    contact_h2: "Get in Touch",
    contact_p: "First consultation is free. Don't hesitate to reach out with any questions.",
    form_name: "Name",
    form_email: "Email",
    form_tel: "Phone",
    form_msg: "Message",
    ...
    sent_desc: "We'll get back to you within 3 business days.",
    lang_toggle: "日本語",
  },
};
      ...
      <header style={{position:"fixed",top:0,left:0,right:0,zIndex:100,background:scrolled?"rgba(255,255,255,.97)":"transparent",borderBottom:scrolled?"1px solid #eee":"none",boxShadow:scrolled?"0 2px 20px rgba(0,0,0,.06)":"none",transition:"all .3s"}}>
        <div style={{maxWidth:1100,margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 32px",height:64}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:4,flexWrap:"wrap"}}>
            ...
            <button className={`lang-btn ${scrolled?"lang-btn-dark":""}`} style={{marginLeft:12}} onClick={()=>setLang(l=>l==="ja"?"en":"ja")}>{t.lang_toggle}</button>
          </div>
        </div>
      </header>
